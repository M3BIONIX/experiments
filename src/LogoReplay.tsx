...
export function LogoReplay(){
 ...
 return <div className="article-page replay-page"><header className="article-bar"><div className="article-home brand-home"><a aria-label="About Fly Logo" href="#/experiments/fly-logo"><ArrowLeftIcon aria-hidden="true"/><span>Fly Logo</span></a><span className="brand-credit">of <a href="https://m3bionix.com/">M3BIONIX</a></span></div><a className="replay-download" href={root+'summary.json'} download>Download results <DownloadIcon aria-hidden="true"/></a></header>
